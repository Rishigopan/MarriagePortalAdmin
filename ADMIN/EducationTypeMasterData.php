...
$find_data = mysqli_query($con, "SELECT ET.edTyId,ET.educationType,EC.educationCategory FROM educationtype ET INNER JOIN educationcategory EC ON ET.educationCategoryId = EC.edcatId;");
