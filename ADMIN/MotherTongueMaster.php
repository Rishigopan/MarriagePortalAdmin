...
<body>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content cntrymodalbg">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Mother Tongue</h5>
                ...
                <div class="modal-body">
                    <form action="" id="AddMaster" class="AddForm">
                        <div class="row pt-3">
                            <div class="col-12">
                                <label for="mother_tongue" class="mt-3">Mother Tongue</label>
                                <input class="form-control mb-3" type="text" placeholder=" " id="mother_tongue" name="MotherTongue" required>
                    ...
                    <form action="" id="UpdateMaster" class="UpdateForm" style="display:none;">
                        <div class="row pt-3">
                            <div class="col-12">
                                <input type="hidden" id="update_mother_tongue_id" name="UpdateMotherTongueId">
                                <label for="update_mother_tongue" class="mt-3">Mother Tongue</label>
                                <input class="form-control mb-3" type="text" id="update_mother_tongue" placeholder=" " name="UpdateMotherTongue" required>
                                <div class="d-flex justify-content-center">
    ...
    <div class="modal fade" id="delModal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4 class="text-center">Do you want to delete this Mother Tongue?</h4>
            ...
            <div class="container-fluid mainContents">
                <div class="card card-body main_card shadow-lg p-3 mb-5">
                    <div class="main_heading d-flex justify-content-between mb-2 shadow p-2">
                        <div>
                            <h3 class="pt-3">MOTHER TONGUE</h3>
                        </div>
                        <div class="">
                            <button class="btn AddBtn mt-1" data-bs-toggle="modal" data-bs-target="#MasterModal">Add Mother Tongue</button>
                        </div>
                    </div>
                        ...
                        <div class="card card-body">
                            <div class="row justify-content-between">
                                <div class="col-lg-4 col-4 mt-3">
                                    <input type="text" class="form-control" id="SearchBar" placeholder="Search by Mother Tongue">
                                </div>
    ...
    <script>
        ...
        var MasterTable = $('#MasterTable').DataTable({
            "processing": true,
            //"responsive": true,
            "ajax": "MotherTongueMasterData.php",
            "scrollY": "600px",
            "scrollX": true,
            "scrollCollapse": true,
            "fixedHeader": true,
        ...
        $(function() {
            ...
            validator.validator.custom = function(el, event) {
                if ($(el).is('#religion_name') && $(el).val().trim().length == 0) {
            ...
            $(document).on('submit', '#AddMaster', (function(e) {
                e.preventDefault();
                $.ajax({
                    url: ApiLink + "/api/mothertongue/add",
                    method: "POST",
                    async: true,
                    crossDomain: true,
                    headers: {
                    ...
                    data: {
                        "motherTongueName": $('#mother_tongue').val(),
                        "createdBy": EmpID,
        ...
        $('#MasterTable tbody').on('click', '.btn_delete', function() {
            ...
            $('#confirmYes').click(function() {
                if (delValue != null) {
                    $.ajax({
                        url: ApiLink + "/api/mothertongue/delete/" + delValue,
                        method: "DELETE",
                        async: true,
                        crossDomain: true,
                        headers: {
        ...
        $(function() {
            ...
            validator.validator.custom = function(el, event) {
                if ($(el).is('#update_religion_name') && $(el).val().trim().length == 0) {
                    return 'Cannot be empty';
                }
                // else if($(el).is('#update_country_name') && $(el).val().match(/[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?0-9]+/)){
                //     return 'Only allowed alphabets';
            ...
            $(document).on('submit', '#UpdateMaster', (function(e) {
                e.preventDefault();
                var UpdateId = $('#update_mother_tongue_id').val();
                console.log(UpdateId);
                $.ajax({
                    url: ApiLink + "/api/mothertongue/update/" + UpdateId,
                    method: "PUT",
                    async: true,
                    crossDomain: true,
                    headers: {
                    ...
                    data: {
                        "motherTongueName": $('#update_mother_tongue').val(),
                        "updatedBy": EmpID,
        ...
        $('#MasterTable').on('click', '.btn_edit', function() {
            ...
            console.log(EditId);
            $.ajax({
                url: ApiLink + "/api/mothertongue/viewid/" + EditId,
                method: "GET",
                async: true,
                crossDomain: true,
                headers: {
                ...
                $('#update_mother_tongue').val(ViewEditValues.motherTongue);
                $('#update_mother_tongue_id').val(EditId);
