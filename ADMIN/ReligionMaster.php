            ...
            <div class="modal-content cntrymodalbg">
                ...
                <div class="modal-body">
                    <form action="" id="AddMaster" class="AddForm">
                        <div class="row pt-3">
                            <div class="col-12">
                                <label for="religion_name" class="mt-3">Religion</label>
                                <input class="form-control mb-3" type="text" placeholder=" " id="religion_name" name="ReligionName" required>
                    ...
                    <form action="" id="UpdateMaster" class="UpdateForm" style="display:none;">
                        <div class="row pt-3">
                            <div class="col-12">
                                <input type="hidden" id="update_religion_id" name="UpdateReligionId">
                                <label for="update_religion_name" class="mt-3">Religion</label>
                                <input class="form-control mb-3" type="text" id="update_religion_name" placeholder=" " name="UpdateReligionName" required>
                                <div class="d-flex justify-content-center">
            ...
            <div class="container-fluid mainContents">
                <div class="card card-body main_card shadow-lg p-3 mb-5">
                    <div class="main_heading d-flex justify-content-between mb-2 shadow p-2">
                        <div>
                            <h3 class="pt-3">RELIGION</h3>
                        </div>
                        <div class="">
                            <button class="btn AddBtn mt-1" data-bs-toggle="modal" data-bs-target="#MasterModal">Add Religion</button>
                        </div>
                    </div>
                        ...
                        <div class="card card-body">
                            <div class="row justify-content-between">
                                <div class="col-lg-4 col-4 mt-3">
                                    <input type="text" class="form-control" id="SearchBar" placeholder="Search by Religion">
                                </div>
    ...
    <script>
        ...
        $(function() {
            ...
            $(document).on('submit', '#AddMaster', (function(e) {
                ...
                $.ajax({
                    ...
                    data: {
                        "religionName": $('#religion_name').val(),
                        "createdBy": EmpID,
        ...
        $('#MasterTable tbody').on('click', '.btn_delete', function() {
            ...
            $('#confirmYes').click(function() {
                if (delValue != null) {
                    $.ajax({
                        url: ApiLink + "/api/religion/delete/" + delValue,
                        method: "DELETE",
                        async: true,
                        crossDomain: true,
                        headers: {
        ...
        $(function() {
            ...
            $(document).on('submit', '#UpdateMaster', (function(e) {
                ...
                $.ajax({
                    url: ApiLink + "/api/religion/update/" + UpdateId,
                    method: "PUT",
                    async: true,
                    crossDomain: true,
                    headers: {
                    ...
                    data: {
                        "religionName": $('#update_religion_name').val(),
                        "updatedBy": EmpID,
        ...
        $('#MasterTable').on('click', '.btn_edit', function() {
            ...
            console.log(EditId);
            $.ajax({
                url: ApiLink + "/api/religion/viewid/" + EditId,
                method: "GET",
                async: true,
                crossDomain: true,
                headers: {
                ...
                $('#update_religion_name').val(ViewEditValues.religion);
                $('#update_religion_id').val(EditId);
