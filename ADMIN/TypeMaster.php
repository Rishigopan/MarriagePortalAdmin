            ...
            <div class="modal-content cntrymodalbg">
                ...
                <div class="modal-body">
                    <form action="" id="AddMaster" class="AddForm" novalidate>
                        <div class="row pt-3">
                            <div class="col-12">
                                <label class="mt-3">Type Name</label>
                                <input class="form-control mb-3" type="text" placeholder=" " id="type_name" name="TypeName" required>
                            </div>
                            <div class="col-12">
                    ...
                    <form action="" id="UpdateMaster" class="UpdateForm" style="display:none;" novalidate>
                        <div class="row pt-3">
                            <input class="form-control mb-3" type="number" placeholder=" " id="update_type_id" name="UpdateTypeId" required hidden>
                            <div class="col-12">
                                <label class="mt-3">Type Name</label>
                                <input class="form-control mb-3" type="text" placeholder=" " id="update_type_name" name="UpdateTypeName" required>
                            </div>
                            <div class="col-12">
                                <label class="mt-3">Abbreviation</label>
    ...
    <div class="modal fade" id="delModal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4 class="text-center">Do you want to delete this Type?</h4>
            ...
            <div class="container-fluid mainContents">
                <div class="card card-body main_card shadow-lg p-3 mb-5">
                    <div class="main_heading d-flex justify-content-between mb-2 shadow p-2">
                        ...
                        <div class="">
                            <button class="btn AddBtn mt-1" data-bs-toggle="modal" data-bs-target="#MasterModal">Add Type</button>
                        </div>
                    </div>
                        ...
                        <div class="card card-body">
                            <div class="row justify-content-between">
                                <div class="col-lg-4 col-4 mt-3">
                                    <input type="text" class="form-control" id="SearchBar" placeholder="Search by Type">
                                </div>
    ...
    <script>
            ...
            "columns": [{
                ...
                // },
                {
                    ...
                    "render": function(data, type, row, meta) {
                        ...
                        if (data.isDeletable == 'NO') {
                            data = '<div class="d-flex justify-content-center me-3">  <button disabled class="btn btn_actions btn_edit me-3" data-bs-toggle="tooltip" data-bs-custom-class="edit-tooltip" data-bs-placement="top" data-bs-title="Edit" value=""><i class="material-icons">edit</i> </button> <button disabled class="btn btn_actions btn_delete" data-bs-toggle="tooltip" data-bs-custom-class="delete-tooltip" data-bs-placement="top" data-bs-title="Delete" value=""><i class="material-icons">delete</i> </button>  </div>'
                        } else {
        ...
        $(function() {
            ...
            validator.validator.custom = function(el, event) {
                if ($(el).is('#type_name,#type_abbreviation') && $(el).val().trim().length == 0) {
                    return 'Cannot be empty';
                } else if ($(el).is('#type_name,#type_abbreviation') && $(el).val().match(/[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?0-9]+/)) {
                    return 'Only alphabets are allowed';
                } else if ($(el).is('#type_name') && $(el).val().trim().length > 20) {
            ...
            $(document).on('submit', '#AddMaster', (function(e) {
                e.preventDefault();
                $.ajax({
                    url: ApiLink + "/api/datasource/add",
                    method: "POST",
                    async: true,
                    crossDomain: true,
                    headers: {
        ...
        $(function() {
            ...
            validator.validator.custom = function(el, event) {
                if ($(el).is('#update_type_name,#update_type_abbreviation') && $(el).val().trim().length == 0) {
                    return 'Cannot be empty';
                } else if ($(el).is('#update_type_name,#update_type_abbreviation') && $(el).val().match(/[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?0-9]+/)) {
                    return 'Only alphabets are allowed';
                } else if ($(el).is('#update_type_name') && $(el).val().trim().length > 20) {
                    return 'Maximum 20 letters is allowed';
            ...
            $(document).on('submit', '#UpdateMaster', (function(e) {
                e.preventDefault();
                var UpdateId = $('#update_type_id').val();
                console.log(UpdateId);
                $.ajax({
                    url: ApiLink + "/api/datasource/update/" + UpdateId,
                    method: "PUT",
                    async: true,
                    crossDomain: true,
                    headers: {
        ...
        $('#MasterTable').on('click', '.btn_edit', function() {
            ...
            console.log(EditId);
            $.ajax({
                url: ApiLink + "/api/datasource/viewid/" + EditId,
                method: "GET",
                async: true,
                crossDomain: true,
                headers: {
                ...
                $('#update_type_name').val(ViewEditValues.TypeName);
                $('#update_type_abbreviation').val(ViewEditValues.TypeAbbreviation);
                $('#update_type_id').val(EditId);
        ...
        $('#MasterTable tbody').on('click', '.btn_delete', function() {
            ...
            $('#confirmYes').click(function() {
                if (delValue != null) {
                    $.ajax({
                        url: ApiLink + "/api/datasource/delete/" + delValue,
                        method: "DELETE",
                        async: true,
                        crossDomain: true,
                        headers: {
