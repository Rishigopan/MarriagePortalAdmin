            ...
            <div class="modal-content cntrymodalbg">
                ...
                <div class="modal-body">
                    <form action="" id="AddMaster" class="AddForm">
                        <div class="row pt-3">
                            <div class="col-12">
                                ...
                                <select class="form-select" aria-label="Default select example" name="feedbackdata" id="feedback_data" required>
                                    <option hidden value="">Select Data</option>
                                    <option value="Bulk Data">Bulk Data</option>
                                    <option value="Lead Data">lead Data</option>
                                    <option value="Free Data">Free Data</option>
                                    <option value="Paid Data">Paid Data</option>
                                    <option value="Marriage Data">Marriage Data</option>
                                    <option value="Wedding Data">Wedding Data</option>
                                </select>
                                <label class="mt-3">Feedback Name</label>
                                <input class="form-control mb-3" type="text" placeholder=" " id="feedback_name" name="feedbackname" required>
                                <label class="mt-3">Feedback Color</label>
                                <input class="form-control mb-3" type="color" placeholder=" " id="feedback_color" name="feedbackcolor" required>
                    ...
                    <form action="" id="UpdateMaster" class="UpdateForm" style="display:none;">
                        <div class="row pt-3">
                            <div class="col-12">
                                <input type="hidden" id="UpdateFeedbackId" name="UpdateFeedbackId">
                                <label class="mt-3">Data</label>
                                <select class="form-select" id="updatefeedbackdata" name="updatefeedbackdata" required>
                                ...
                                <label class="mt-3">Feedback Name</label>
                                <input class="form-control mb-3" type="text" id="UpdateFeedbackName" placeholder=" " name="updatefeedbackname" required>

                                <label class="mt-3">Feedback Color</label>
                                <input class="form-control mb-3" type="color" placeholder=" " id="update_feedback_color" name="UpdateFeedbackColor" required>
                                <div class="d-flex justify-content-center">
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Feedback Master</li>
                </ol>
            </nav>
        </div>
            ...
            <div class="container-fluid mainContents">
                <div class="card card-body main_card shadow-lg p-3 mb-5">
                    <div class="main_heading d-flex justify-content-between mb-2 shadow p-2">
                        ...
                        <div class="">
                            <button class="btn AddBtn mt-1" data-bs-toggle="modal" data-bs-target="#MasterModal">Add Feedback</button>
                        </div>
                    </div>
                        ...
                        <div class="card card-body">
                            <div class="row justify-content-between">
                                <div class="col-lg-4 col-4 mt-3">
                                    <input type="text" class="form-control" id="SearchBar" placeholder="Search by Feedback">
                                </div>
                    ...
                    <div class="">
                        <table class="table table-hover mastertable" id="MasterTable" style="width: 100%;">
                            <thead class="table-light">
                                <tr>
                                    <th class="">Sl No</th>
                                    <th class="">Feedback Name</th>
                                    <th class="">Feedback Data Type</th>
                                    <!-- <th class="">Email</th>
    ...
    <script>
        ...
        $(function() {
            ...
            validator.validator.custom = function(el, event) {
                if ($(el).is('#feedback_name') && $(el).val().trim().length == 0) {
            ...
            $(document).on('submit', '#AddMaster', (function(e) {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        "feedbackData": $('#feedback_data').val(),
                        "feedbackType": "",
                        "feedbackColor": $('#feedback_color').val(),
                        "feedbackLink": "",
                        "createdBy": EmpID,
        ...
        $(function() {
            ...
            validator.validator.custom = function(el, event) {
                if ($(el).is('#UpdateFeedbackName') && $(el).val().trim().length == 0) {
                    return 'Cannot be empty';
                }
                // else if($(el).is('#update_country_name') && $(el).val().match(/[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?0-9]+/)){
                //     return 'Only allowed alphabets';
            ...
            $(document).on('submit', '#UpdateMaster', (function(e) {
                e.preventDefault();
                var UpdateId = $('#UpdateFeedbackId').val();
                console.log(UpdateId);
                $.ajax({
                    url: ApiLink + "/api/feedback/update/" + UpdateId,
                    method: "PUT",
                    async: true,
                    crossDomain: true,
                    headers: {
                    ...
                    data: {
                        "feedback": $('#UpdateFeedbackName').val(),
                        "feedbackData": $('#updatefeedbackdata').val(),
                        "feedbackType": "",
                        "feedbackColor": $('#update_feedback_color').val(),
                        "feedbackLink": "",
                        "updatedBy": EmpID,
        ...
        $('#MasterTable').on('click', '.btn_edit', function() {
            ...
            console.log(EditId);
            $.ajax({
                url: ApiLink + "/api/feedback/viewid/" + EditId,
                method: "GET",
                async: true,
                crossDomain: true,
                headers: {
                ...
                $('#UpdateFeedbackName').val(ViewEditValues.FeedbackName);
                $('#updatefeedbackdata').val(ViewEditValues.FeedbackData).change();
                $('#update_feedback_color').val(ViewEditValues.FeedbackColor);
                $('#UpdateFeedbackId').val(EditId);
        ...
        $('#MasterTable tbody').on('click', '.btn_delete', function() {
            ...
            $('#confirmYes').click(function() {
                if (delValue != null) {
                    $.ajax({
                        url: ApiLink + "/api/feedback/delete/" + delValue,
                        method: "DELETE",
                        async: true,
                        crossDomain: true,
                        headers: {
        ...
        //             $('.loader').hide();
        //             console.log(data);
        //             var FeedbackResult = JSON.parse(data);
        //             if (FeedbackResult.Status == true) {
        //                 if (FeedbackResult.Code == 0) {
        //                     toastr.warning(FeedbackResult.message);
        //                 } else if (FeedbackResult.Code == 1) {
        ...
        //                 }
        //             } else {
        //                 toastr.error("Feedback Not Added");
        //             }
        //         },
        //         cache: false,
        //         contentType: false,
        ...
        //     var DeleteFeedbackData = $(this).val();
        //     console.log(DeleteFeedbackData);
        //     var FeedbackDeleteConfirm = confirm("Are you sure you want to delete this Feedback?");
        //     if (FeedbackDeleteConfirm == true) {
        //         $.ajax({
        //             url: "MasterOperations.php",
        //             type: "POST",
        //             data: {
        ...
        //             success: function(data) {
        //                 console.log(data);
        //                 var FeedbackResultDelete = JSON.parse(data);
        //                 if (FeedbackResultDelete.Status == true) {
        ...
        // //Update Feedback
        // $('#UpdateFeedback').submit(function(e) {
        //     e.preventDefault();
        //     var UpdateFeedbackData = new FormData(this);
        //     $.ajax({
        //         url: "MasterOperations.php",
        //         method: "POST",
        ...
        //             $('.loader').hide();
        //             console.log(data);
        //             var FeedbackResultUpdate = JSON.parse(data);
        //             if (FeedbackResultUpdate.Status == true) {
        //                 if (FeedbackResultUpdate.Code == 0) {
        //                     toastr.warning(FeedbackResultUpdate.message);
        //                 } else if (FeedbackResultUpdate.Code == 1) {
        //                     toastr.success(FeedbackResultUpdate.message);
        //                     MasterTable.ajax.reload();
        //                 } else {
        //                     toastr.error(FeedbackResultUpdate.message);
        //                 }
        //             } else {
        //                 toastr.error("Feedback Not Added");
        //             }
