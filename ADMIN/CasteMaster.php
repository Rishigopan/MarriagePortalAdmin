                ...
                <div class="modal-body">
                    <form action="" id="AddMaster" class="AddForm">
                        <div class="row pt-3">
                            ...
                            <div class="col-12">
                                <label for="caste_name" class="form-label">Caste</label>
                                <input class="form-control mb-3" type="text" placeholder=" " id="caste_name" name="CasteName" required>
                            </div>
                            <div class="col-12">
                    ...
                    <form action="" id="UpdateMaster" class="UpdateForm" style="display:none;">
                        <div class="row pt-3">
                            <div class="col-12">
                                <input type="hidden" id="update_caste_id" name="UpdateCasteId">
                                <label for="caste_name" class="form-label">Religion</label>
                            ...
                            <div class="col-12">
                                <label for="update_caste_name" class="form-label">Caste</label>
                                <input class="form-control mb-3" type="text" id="update_caste_name" placeholder=" " name="UpdateCasteName" required>
                            </div>
                            <div class="col-12">
                                <div class="d-flex justify-content-center">
            ...
            <div class="container-fluid mainContents">
                <div class="card card-body main_card shadow-lg p-3 mb-5">
                    <div class="main_heading d-flex justify-content-between mb-2 shadow p-2">
                        <div>
                            <h3 class="pt-3">CASTE</h3>
                        </div>
                        <div class="">
                            <button class="btn AddBtn mt-1" data-bs-toggle="modal" data-bs-target="#MasterModal">Add Caste</button>
                        </div>
                    </div>
                        ...
                        <div class="card card-body">
                            <div class="row justify-content-between">
                                <div class="col-lg-4 col-4 mt-3">
                                    <input type="text" class="form-control" id="SearchBar" placeholder="Search by Caste">
                                </div>
    ...
    <script>
        ...
        $(function() {
            ...
            validator.validator.custom = function(el, event) {
                if ($(el).is('#caste_name') && $(el).val().trim().length == 0) {
        ...
        $('#MasterTable tbody').on('click', '.btn_delete', function() {
            ...
            $('#confirmYes').click(function() {
                if (delValue != null) {
                    $.ajax({
                        url: ApiLink + "/api/caste/delete/" + delValue,
                        method: "DELETE",
                        async: true,
                        crossDomain: true,
                        headers: {
        ...
        $(function() {
            ...
            validator.validator.custom = function(el, event) {
                if ($(el).is('#update_caste_name') && $(el).val().trim().length == 0) {
                    return 'Cannot be empty';
                }
                // else if($(el).is('#update_country_name') && $(el).val().match(/[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?0-9]+/)){
                //     return 'Only allowed alphabets';
            ...
            $(document).on('submit', '#UpdateMaster', (function(e) {
                ...
                $.ajax({
                    url: ApiLink + "/api/caste/update/" + UpdateId,
                    method: "PUT",
                    async: true,
                    crossDomain: true,
                    headers: {
                    ...
                    data: {
                        ...
                        "casteName": $('#update_caste_name').val(),
                        "updatedBy": EmpID,
        ...
        $('#MasterTable').on('click', '.btn_edit', function() {
            ...
            console.log(EditId);
            $.ajax({
                url: ApiLink + "/api/caste/viewid/" + EditId,
                method: "GET",
                async: true,
                crossDomain: true,
                headers: {
                ...
                $('#update_caste_name').val(ViewEditValues.caste);
                $('#update_religion_id').val(ViewEditValues.religion).change();
                $('#update_caste_id').val(EditId);
