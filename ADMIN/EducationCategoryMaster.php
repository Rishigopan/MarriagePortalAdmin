...
$PageTitle = 'EducationCategoryMaster';
...
<body>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content cntrymodalbg">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Education Category</h5>
                ...
                <div class="modal-body">
                    <form action="" id="AddMaster" class="AddForm">
                        <div class="row pt-3">
                            <div class="col-12">
                                <label for="education_category_name" class="mt-3">Education Category</label>
                                <input class="form-control mb-3" type="text" placeholder=" " id="education_category_name" name="EducationCategoryName" required>
                    ...
                    <form action="" id="UpdateMaster" class="UpdateForm" style="display:none;">
                        <div class="row pt-3">
                            <div class="col-12">
                                <input type="hidden" id="update_education_category_id" name="UpdateEducationCategoryId">
                                <label for="update_education_category_name" class="mt-3">Education Category</label>
                                <input class="form-control mb-3" type="text" id="update_education_category_name" placeholder=" " name="UpdateEducationCategoryName" required>
                                <div class="d-flex justify-content-center">
    ...
    <div class="modal fade" id="delModal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4 class="text-center">Do you want to delete this Education Category?</h4>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Education Category Master</h1>
            <nav>
                <ol class="breadcrumb">
            ...
            <div class="container-fluid mainContents">
                <div class="card card-body main_card shadow-lg p-3 mb-5">
                    <div class="main_heading d-flex justify-content-between mb-2 shadow p-2">
                        <div>
                            <h3 class="pt-3">EDUCATION CATEGORY</h3>
                        </div>
                        <div class="">
                            <button class="btn AddBtn mt-1" data-bs-toggle="modal" data-bs-target="#MasterModal">Add Education Category</button>
                        </div>
                    </div>
                        ...
                        <div class="card card-body">
                            <div class="row justify-content-between">
                                <div class="col-lg-4 col-4 mt-3">
                                    <input type="text" class="form-control" id="SearchBar" placeholder="Search by Education Category">
                                </div>
    ...
    <script>
        ...
        var MasterTable = $('#MasterTable').DataTable({
            "processing": true,
            //"responsive": true,
            "ajax": "EducationCategoryMasterData.php",
            "scrollY": "600px",
            "scrollX": true,
            "scrollCollapse": true,
            "fixedHeader": true,
        ...
        $(function() {
            ...
            validator.validator.custom = function(el, event) {
                if ($(el).is('#education_category_name') && $(el).val().trim().length == 0) {
            ...
            $(document).on('submit', '#AddMaster', (function(e) {
                ...
                $.ajax({
                    ...
                    data: {
                        "educationCategory": $('#education_category_name').val(),
                        "createdBy": EmpID,
        ...
        $('#MasterTable tbody').on('click', '.btn_delete', function() {
            ...
            $('#confirmYes').click(function() {
                if (delValue != null) {
                    $.ajax({
                        url: ApiLink + "/api/educat/delete/" + delValue,
                        method: "DELETE",
                        async: true,
                        crossDomain: true,
                        headers: {
        ...
        $(function() {
            ...
            validator.validator.custom = function(el, event) {
                if ($(el).is('#update_education_category_name') && $(el).val().trim().length == 0) {
                    return 'Cannot be empty';
                }
                // else if($(el).is('#update_country_name') && $(el).val().match(/[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?0-9]+/)){
                //     return 'Only allowed alphabets';
            ...
            $(document).on('submit', '#UpdateMaster', (function(e) {
                e.preventDefault();
                var UpdateId = $('#update_education_category_id').val();
                console.log(UpdateId);
                $.ajax({
                    url: ApiLink + "/api/educat/update/" + UpdateId,
                    method: "PUT",
                    async: true,
                    crossDomain: true,
                    headers: {
                    ...
                    data: {
                        "educationCategory": $('#update_education_category_name').val(),
                        "updatedBy": EmpID,
        ...
        $('#MasterTable').on('click', '.btn_edit', function() {
            ...
            console.log(EditId);
            $.ajax({
                url: ApiLink + "/api/educat/viewid/" + EditId,
                method: "GET",
                async: true,
                crossDomain: true,
                headers: {
                ...
                $('#update_education_category_name').val(ViewEditValues.educationCategory);
                $('#update_education_category_id').val(EditId);
