...
<body>
            ...
            <div class="modal-content cntrymodalbg">
                ...
                <div class="modal-body">
                    ...
                    <form action="" id="AddMaster" class="AddForm">
                        <div class="row pt-3">
                            <div class="col-12">
                                ...
                                <select class="form-select mb-3" id="country_id" name="CountryId" required>
                                    <option hidden value=''> Select Country </option>
                                    <?php
                                    $FindCountry =  mysqli_query($con, "SELECT cId,countryName FROM country");
                                    foreach ($FindCountry as $FindCountryResult) {
                                        echo "<option value='" . $FindCountryResult['cId'] . "'> " . $FindCountryResult['countryName'] . "  </option>";
                                    }
                                    ?>
                                </select>
                            </div>
                            <div class="col-12">
                                ...
                                <select class="form-select mb-3 ShowState" id="state_id" name="StateIdss" required>
                            ...
                            <div class="col-12">
                                ...
                                <input class="form-control mb-3" type="text" placeholder=" " id="district_name" name="DistrictName" required>
                            </div>
                            <div class="col-12">
                                <label for="district_prefix" class="form-label">District Prefix</label>
                                <input class="form-control mb-3" type="text" placeholder=" " id="district_prefix" name="DistrictPrefix" required>
                            </div>
                            <div class="col-12">
                    ...
                    <form action="" id="UpdateMaster" class="UpdateForm" style="display:none;">
                        <div class="row pt-3">
                            <div class="col-12">
                                <input type="hidden" id="update_district_id" name="UpdateDistrictId">
                                <label for="country_name" class="form-label">Country</label>
                                <select class="form-select mb-3" id="update_country_id" name="UpdateCountryId" required>
                                    <option hidden value=''> Select Country </option>
                                    <?php
                                    foreach ($FindCountry as $FindCountryResult) {
                                        echo "<option value='" . $FindCountryResult['cId'] . "'> " . $FindCountryResult['countryName'] . "  </option>";
                            ...
                            <div class="col-12">
                                ...
                                <select class="form-select mb-3 ShowState" id="update_state" name="UpdateStateId" required>
                                    <option hidden value=''> Select State </option>

                                </select>
                            </div>
                            <div class="col-12">
                                <label for="update_district_name" class="form-label">District</label>
                                <input class="form-control mb-3" type="text" id="update_district_name" placeholder=" " name="UpdateDistrictName" required>
                            </div>
                            <div class="col-12">
                                <label for="update_district_prefix" class="form-label">District Prefix</label>
                                <input class="form-control mb-3" type="text" placeholder=" " id="update_district_prefix" name="UpdateDistrictPrefix" required>
                            </div>
                            <div class="col-12">
                                <div class="d-flex justify-content-center">
    ...
    <div class="modal fade" id="delModal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4 class="text-center">Do you want to delete this District?</h4>
            ...
            <div class="container-fluid mainContents">
                <div class="card card-body main_card shadow-lg p-3 mb-5">
                    <div class="main_heading d-flex justify-content-between mb-2 shadow p-2">
                        <div>
                            <h3 class="pt-3">DISTRICT</h3>
                        </div>
                        <div class="">
                            <button class="btn AddBtn mt-1" data-bs-toggle="modal" data-bs-target="#MasterModal">Add District</button>
                        </div>
                    </div>
                        ...
                        <div class="card card-body">
                            <div class="row justify-content-between">
                                <div class="col-lg-4 col-4 mt-3">
                                    <input type="text" class="form-control" id="SearchBar" placeholder="Search by District">
                                </div>
    ...
    <script>
        ...
        function FetchStateByCountry(CountryId) {
            $.ajax({
        ...
        //Fetch state by country in add form
        ...
        //Fetch  state by country in update form
        $(document).on('click', '#update_country_id', function() {
        ...
        $(function() {
            ...
            validator.validator.custom = function(el, event) {
                if ($(el).is('#district_name,#district_prefix') && $(el).val().trim().length == 0) {
                    return 'Cannot be empty';
                }
                else if($(el).is('#district_name,#district_prefix') && $(el).val().match(/[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?0-9]+/)){
                    return 'Only allowed alphabets';
                }
                else if($(el).is('#district_name') && $(el).val().trim().length > 20){
                    return 'Maximum 20 letters is allowed';
                }
                else if($(el).is('#district_prefix') && $(el).val().trim().length > 2){
                    return 'Maximum 2 letters is allowed';
                }
            ...
            $(document).on('submit', '#AddMaster', (function(e) {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        "districtPrefix": $('#district_prefix').val(),
                        "createdBy": EmpID,
        ...
        $('#MasterTable tbody').on('click', '.btn_delete', function() {
            ...
            $('#confirmYes').click(function() {
                if (delValue != null) {
                    $.ajax({
                        url: ApiLink + "/api/district/delete/" + delValue,
                        method: "DELETE",
                        async: true,
                        crossDomain: true,
                        headers: {
        ...
        $(function() {
            ...
            validator.validator.custom = function(el, event) {
                if ($(el).is('#update_district_name,#update_district_prefix') && $(el).val().trim().length == 0) {
                    return 'Cannot be empty';
                }
                else if($(el).is('#update_district_name,#update_district_prefix') && $(el).val().match(/[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?0-9]+/)){
                    return 'Only allowed alphabets';
                }
                else if($(el).is('#update_district_name') && $(el).val().trim().length > 20){
                    return 'Maximum 20 letters is allowed';
                }
                else if($(el).is('#update_district_prefix') && $(el).val().trim().length > 2){
                    return 'Maximum 2 letters is allowed';
                }
            ...
            $(document).on('submit', '#UpdateMaster', (function(e) {
                e.preventDefault();
                var UpdateId = $('#update_district_id').val();
                console.log(UpdateId);
                $.ajax({
                    url: ApiLink + "/api/district/update/" + UpdateId,
                    method: "PUT",
                    async: true,
                    crossDomain: true,
                    headers: {
                    ...
                    data: {
                        "countryId": $('#update_country_id').val(),
                        "stateId": $('#update_state').val(),
                        "districtName": $('#update_district_name').val(),
                        "districtPrefix": $('#update_district_prefix').val(),
                        "updatedBy": EmpID,
        ...
        $('#MasterTable').on('click', '.btn_edit', function() {
            ...
            console.log(EditId);
            $.ajax({
                url: ApiLink + "/api/district/viewid/" + EditId,
                method: "GET",
                async: true,
                crossDomain: true,
                headers: {
                ...
                $.ajax({
                    ...
                    crossDomain: true,
                    data: {
                        fetchState: ViewEditValues.country
                    },
                    beforeSend: function() {},
                }).done(function(data) {
                    console.log(data);
                    $('.ShowState').html(data);
                    $('#update_state').val(ViewEditValues.state).change();
                });
                $('#update_country_id').val(ViewEditValues.country);
                $('#update_district_name').val(ViewEditValues.district);
                $('#update_district_prefix').val(ViewEditValues.districtPrefix);
                $('#update_district_id').val(EditId);
