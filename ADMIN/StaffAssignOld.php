...
<body>
    ...
    <main id="main" class="main">
        ...
        <section class="section dashboard">
            ...
            <div class="container-fluid pb-2 FilterSection">
                        ...
                        <div class="col-xl-1 col-lg-3 col-6 mt-1 mt-xl-2 selectMargin">
                            <div class="row bg-info">
                                ...
                                <div class="col-xl-4 col-lg-5 col-5 text-start">
                                    <button type="submit" class="btn  m-0" id="searchButton"><i class="ri-search-2-line iconSearch"></i></button>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-xl-2 col-lg-3 col-6 text-start mt-1">
                                    <div class="row">
                                        ...
                                        <div class="col-6 mt-1">
                                            ...
                                            <label for="selectAllCustomers"> Select </label>
                                        </div>
                                    </div>
                                </div>
