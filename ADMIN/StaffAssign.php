...
<body>
                        ...
                        <form action="" method="" id="FreeRegister" class="">
                            <div class="row mt-3 modalForm">
                                ...
                                <div class="col-12 form-group mt-3">
                                    ...
                                    <input type="text" name="PartnerPrefer" class="form-control">
                                </div>
                                <div class="col-12 form-group mt-3">
                                    <label for="" class="mb-1 ms-2">Remarks</label>
                                    <input type="text" name="FeedbackRemark" class="form-control">
                                </div>
                                <div class="row">
            ...
            <div class="container-fluid pb-2">
                ...
                <form id="FilterData">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-xl-1 col-lg-3 col-6 mt-1 selectMargin">
                            <select class="form-control select dropDnLightPink" id="member_online" name="MemberOnline">
                        ...
                        <div class="col-xl-2 col-lg-3 col-6 mt-1 selectMargin">
                            <div class="row">
                                <div class="col-xl-6 col-lg-4 col-6 text-center">
                        ...
                        <div class="col-xl-1 col-lg-3 col-6 mt-1">
                            <div class="row">
                                ...
                                <div class="col-xl-12 col-lg-6 col-6 text-center ps-0 ms-0 pt-1">
                    ...
                    <!-- Staff Assign Section -->
                    <div class="row mt-2 mb-3">

                        <div class="col-md-9 pb-2 AssignSection">
                            <div class="row">
                                <div class="col-xl-2 col-lg-3 col-6 text-start mt-1">
                                    <div class="row">
                                        ...
                                        <div class="col-6 mt-1">
                                            ...
                                            <label for="selectAllCustomers"> SEL </label>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-3">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-6 text-center mt-2">
                                    <!-- <button type="submit" class="btn m-0 SearchButton rounded-pill" id="searchButton"><i class="ri-search-2-line"></i> SEARCH</button> -->
                                    <button class="form-control btnBlue bg-secondary rounded-pill" type="type" id="clearAll"><i class="ri-refresh-line"></i> RESET</button>
                                </div>
                                <div class="col-md-6 col-6 text-center mt-2">
                                    <!-- <button type="submit" class="btn m-0 SearchButton rounded-pill" id="searchButton"><i class="ri-search-2-line"></i> SEARCH</button> -->
                                    <button class="form-control btnBlue SearchButton rounded-pill" type="submit" id="searchButton"><i class="ri-search-2-line"></i> SEARCH</button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div>
                        ...
                        <input type="text" value="" id="temp_data_type" name="TempDataType" hidden>
    ...
    <script>
        ...
        ////////////////  Staff Assign Functions  /////////////////

        // Function to select all customers
        $('#selectAllCustomers').click(function() {
            var DataChoosen = $('#temp_data_type').val();
            if (DataChoosen == 'FD' || DataChoosen == 'MD' || DataChoosen == 'PD' || DataChoosen == 'WD') {
                $('.FreeDataSelect').prop('checked', this.checked);
            } else if (DataChoosen == 'BD' || DataChoosen == 'LD') {
                $('.MainSelector').prop('checked', this.checked);
            } else {
                toastr.error('Some Error Ocucured');
            }
        });
        ...
        $('#assignCustomers').click(function() {
            ...
            var DataType = $('#temp_data_type').val();
            if (DataType == 'FD' || DataType == 'MD' || DataType == 'PD' || DataType == 'WD') {
                $('.FreeDataSelect:checked').each(function() {
                    SelectedCustomers.push($(this).val());
                });
            } else if (DataType == 'BD' || DataType == 'LD') {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    } else if (AssignResult.Success == 0) {
                        toastr.warning('Please Select Atleast One Profile');
                    } else if (AssignResult.Success == 3) {
                        toastr.warning('Please Select Staff');
                    } else if (AssignResult.Success == 4) {
                        toastr.warning('Please Select Staff and Profile');
                    } else {
                        toastr.error('Some Error Ocucured');
                    }
                }
        ...
        $('#unassignCustomers').click(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    } else if (UnAssignResult.UnAssign == 0) {
                        toastr.warning('Please Select Atleast One Profile');
                    } else if (UnAssignResult.UnAssign == 3) {
                        toastr.warning('Please Select Staff');
                    } else if (UnAssignResult.UnAssign == 4) {
                        toastr.warning('Please Select Staff and Profile');
                    } else {
                        toastr.error('Some Error Ocucured');
                    }
