            ...
            <div class="modal-content cntrymodalbg">
                ...
                <div class="modal-body">
                    <form action="" id="AddMaster" class="AddForm">
                        <div class="row pt-3">
                            <div class="col-12">
                                <label for="job_type_name" class="mt-3">Job Type</label>
                                <input class="form-control mb-3" type="text" placeholder=" " id="job_type_name" name="JobTypeName" required>
                    ...
                    <form action="" id="UpdateMaster" class="UpdateForm" style="display:none;">
                        <div class="row pt-3">
                            <div class="col-12">
                                <input type="hidden" id="update_jobcategory_id" name="UpdateJobTypeId">
                                <label for="update_job_type_name" class="mt-3">Job Type</label>
                                <input class="form-control mb-3" type="text" id="update_job_type_name" placeholder=" " name="UpdateJobTypeName" required>
                                <div class="d-flex justify-content-center">
    ...
    <div class="modal fade" id="delModal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4 class="text-center">Do you want to delete this Job Type?</h4>
            ...
            <div class="container-fluid mainContents">
                <div class="card card-body main_card shadow-lg p-3 mb-5">
                    <div class="main_heading d-flex justify-content-between mb-2 shadow p-2">
                        <div>
                            <h3 class="pt-3">JOB TYPE</h3>
                        </div>
                        <div class="">
                            <button class="btn AddBtn mt-1" data-bs-toggle="modal" data-bs-target="#MasterModal">Add Job Type</button>
                        </div>
                    </div>
                        ...
                        <div class="card card-body">
                            <div class="row justify-content-between">
                                <div class="col-lg-4 col-4 mt-3">
                                    <input type="text" class="form-control" id="SearchBar" placeholder="Search by Job Type">
                                </div>
    ...
    <script>
        ...
        $(function() {
            ...
            validator.validator.custom = function(el, event) {
                if ($(el).is('#job_type_name') && $(el).val().trim().length == 0) {
        ...
        $('#MasterTable tbody').on('click', '.btn_delete', function() {
            ...
            $('#confirmYes').click(function() {
                if (delValue != null) {
                    $.ajax({
                        url: ApiLink + "/api/jobtype/delete/" + delValue,
                        method: "DELETE",
                        async: true,
                        crossDomain: true,
                        headers: {
        ...
        $(function() {
            ...
            validator.validator.custom = function(el, event) {
                if ($(el).is('#update_job_type_name') && $(el).val().trim().length == 0) {
                    return 'Cannot be empty';
                }
                // else if($(el).is('#update_country_name') && $(el).val().match(/[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?0-9]+/)){
                //     return 'Only allowed alphabets';
            ...
            $(document).on('submit', '#UpdateMaster', (function(e) {
                ...
                $.ajax({
                    url: ApiLink + "/api/jobtype/update/" + UpdateId,
                    method: "PUT",
                    async: true,
                    crossDomain: true,
                    headers: {
                    ...
                    data: {
                        "jobCategoryId": "1",
                        "jobType": $('#update_job_type_name').val(),
                        "updatedBy": EmpID,
        ...
        $('#MasterTable').on('click', '.btn_edit', function() {
            ...
            console.log(EditId);
            $.ajax({
                url: ApiLink + "/api/jobtype/viewid/" + EditId,
                method: "GET",
                async: true,
                crossDomain: true,
                headers: {
                ...
                $('#update_job_type_name').val(ViewEditValues.JobType);
